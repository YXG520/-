...
<form action="<c:url value='/update?cid=${customer.cid}'/>" method="post">
	...
	<tr>
		...
		<td>
			<input type="radio" name="gender" value="男" 
			  <c:if test="${customer.gender eq '男'}">checked</c:if>  id="male"/>
			<label for="male">男</label>
			<input type="radio" name="gender" 
			<c:if test="${customer.gender eq '女'}">checked</c:if> value="女"  id="female"  />
